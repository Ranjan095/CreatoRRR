...
const Edit_profile = () => {
  ...
  let [profile, setProfile] = useState(initialData);
  let param = useParams();
  ...
  let handleSubmit = (e) => {
    e.preventDefault();
    storage_data.splice(index, 1, profile);
    sessionStorage.setItem("data", JSON.stringify(storage_data));
  ...
  return (
    <section>
      <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24 ">
        <div className="sm:w-[400px] md:w-[600px] border-red-400">
